import DR.Endpoint.LongColumnKernel
...
theorem longColumn_contender_kernel_of_caps {m n : ℕ} (hm : 16 ≤ m)
  ...
  have hpos := longColumn_retained_kernel_posDef hm hn T
...
theorem uniform_maximum_endpoint_of_longColumn_caps {m n : ℕ} (hm : 16 ≤ m)
    (hn : 10000*m^2 ≤ n)
  ...
  exact longColumn_contender_kernel_of_caps hm hn hP hr hc
